...
<div id="carousel-container">
  <div id="carousel">
    <div class="carousel-item">
        <img src="./Images/Le_materiel_roulant/Wagon_fret/Wagon_cerealers/Taille G/wagon_cerealier_tailleG_vue1.png" alt="WagonCerealierTailleGvue1" id="CerealierTailleGVue1">
    </div>
    <div class="carousel-item">
    <img src="./Images/Le_materiel_roulant/Wagon_fret/Wagon_cerealers/Taille G/wagon_cerealier_tailleG_vue2.png" alt="WagonCerealierTailleGvue2" id="CerealierTailleGVue2">
    </div>
  </div>
</div>
<div class="bouton">
