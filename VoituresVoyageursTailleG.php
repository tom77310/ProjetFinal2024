...
<div id="carousel-container">
  <div id="carousel">
    <div class="carousel-item">
        <img src="./Images/Le_materiel_roulant/Voiture_voyageurs/Taille G/voiture_voyageurs_talleG_vue1.png" alt="VoituresVoyageursTailleGvue1" id="VoituresVoyageursTailleGVue1">
    </div>
    <div class="carousel-item">
    <img src="./Images/Le_materiel_roulant/Voiture_voyageurs/Taille G/voiture_voyageurs_talleG_vue2.png" alt="VoituresVoyageursTailleGvue2" id="VoituresVoyageursTailleGVue2">
    </div>
  </div>
</div>
<div class="bouton">
