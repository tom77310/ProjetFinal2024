...
<div id="carousel-container">
  <div id="carousel">
    <div class="carousel-item">
        <img src="./Images/Le_materiel_roulant/Loco/loco vapeur/Taille G/loco_vapeur_tailleG_vue1.png" alt="LocoVapeurTailleGvue1" id="LocoVapeurTailleGVue1">
    </div>
    <div class="carousel-item">
    <img src="./Images/Le_materiel_roulant/Loco/loco vapeur/Taille G/loco_vapeur_tailleG_vue2.png" alt="LocoVapeurTailleGvue2" id="LocoVapeurTailleGVue2">
    </div>
    <div class="carousel-item">
    <img src="./Images/Le_materiel_roulant/Loco/loco vapeur/Taille G/loco_vapeur_tailleG_vue3.png" alt="LocoVapeurTailleGvue3" id="LocoVapeurTailleGVue3">
    </div>
   </div>
</div>
<div class="bouton">
