...
<div id="carousel-container">
  <div id="carousel">
    <div class="carousel-item">
        <img src="./Images/Le_materiel_roulant/Loco/loco elec/Taille N/loco_elec_tailleN_vue1.png" alt="LocoElecTailleNvue1" id="LocoElecTailleNVue1">
    </div>
    <div class="carousel-item">
    <img src="./Images/Le_materiel_roulant/Loco/loco elec/Taille N/loco_elec_tailleN_vue2.png" alt="LocoElecTailleNvue2" id="LocoElecTailleNVue2">
    </div>
  </div>
</div>
<div class="bouton">
