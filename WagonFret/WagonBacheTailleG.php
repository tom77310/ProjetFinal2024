...
<div id="carousel-container">
  <div id="carousel">
    <div class="carousel-item">
        <img src="./Images/WagonFret/Wagon_bachés/Taille G/wagon_baché_tailleG_vue1.png" alt="WagonBacheTailleGvue1" id="BacheTailleGVue1">
    </div>
    <div class="carousel-item">
    <img src="./Images/WagonFret/Wagon_bachés/Taille G/wagon_baché_tailleG_vue2.png" alt="WagonBacheTailleGvue2" id="BacheTailleGVue2">
    </div>
   </div>
</div>
<div class="bouton">
