...
<div id="carousel-container">
  <div id="carousel">
    <div class="carousel-item">
        <img src="./Images/WagonFret/Wagon_plat_porte_conteur/page_produit_g/wagon_porte_containeur_taille_G_vue1.png" alt="WagonContneurTailleGvue1" id="ConteneurTailleGVue1">
    </div>
    <div class="carousel-item">
    <img src="./Images/WagonFret/Wagon_plat_porte_conteur/page_produit_g/wagon_porte_containeur_taille_G_vue2.png" alt="WagonContneurTailleGvue2" id="ConteneurTailleGVue2">
    </div>
   </div>
</div>
<div class="bouton">
